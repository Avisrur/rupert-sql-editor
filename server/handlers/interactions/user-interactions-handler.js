const userInteractionService = require("../../services/user-interactions-service");
...
const handleUserInteractions = async (db, newQueryID, interactions) => {
  for (let interaction of interactions) {
    ...
    await userInteractionService.createNewUserInteraction(db, newInteractionId, interaction, newQueryID);
  }
};
